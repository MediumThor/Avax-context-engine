...
- Phone bottom dest nav (and desktop left dest rail) is five destinations: Market, Replay, Accuracy, Health, More. Same dest names and URLs at every breakpoint.
